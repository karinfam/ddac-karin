...
namespace DDAC.Controllers
{
    public class ShipsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ShipID,MaxLoad,FleetID")] Ship ship)
        {
            ...
            ViewBag.FleetID = new SelectList(db.Fleets, "FleetID", "Name", ship.FleetID);
            return View(ship);
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ShipID,MaxLoad,FleetID")] Ship ship)
        {
            if (ModelState.IsValid)
            {
